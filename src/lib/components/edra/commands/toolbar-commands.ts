	...
	alignment: [
		{
			...
			isActive: (editor: Editor): boolean => editor.isActive({ textAlign: 'left' })
		},
		{
			icon: AlignCenter,
			name: 'align-center',
			...
			isActive: (editor: Editor): boolean => editor.isActive({ textAlign: 'center' })
		},
		{
			icon: AlignRight,
			name: 'align-right',
			...
			isActive: (editor: Editor): boolean => editor.isActive({ textAlign: 'right' })
		},
		{
			icon: AlighJustify,
			name: 'align-justify',
			...
			isActive: (editor: Editor): boolean => editor.isActive({ textAlign: 'justify' })
		}
	],
	lists: [
		{
			...
			isActive: (editor: Editor): boolean => editor.isActive('bulletList')
		},
		{
			icon: ListOrdered,
			name: 'orderedList',
	...
	media: [
		{
			...
			isActive: (editor: Editor): boolean => editor.isActive('image-placeholder')
		},
		{
			icon: Video,
			...
			isActive: (editor: Editor): boolean => editor.isActive('video-placeholder')
		},
		{
			icon: Audio,
			...
			isActive: (editor: Editor): boolean => editor.isActive('audio-placeholder')
		},
		{
			icon: IFrame,
			...
			isActive: (editor: Editor): boolean => editor.isActive('iframe-placeholder')
		}
	],
	table: [
		{
			...
			isActive: (editor: Editor): boolean => editor.isActive('table')
		}
	],
	math: [
		{
			...
			isActive: (editor: Editor): boolean => editor.isActive('inlineMath')
		},
		{
			icon: SquareRadical,
			name: 'mathematics',
			...
			isActive: (editor: Editor): boolean => editor.isActive('blockMath')
		}
	]
};
